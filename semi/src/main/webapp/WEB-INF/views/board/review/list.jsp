...
<c:set var="pageCss" value="/css/board_list.css,/css/review.css" scope="request"/>
...
<div class="container w-1200 board-page">
	...
	<c:choose>
		<c:when test="${empty boardList}">
			<div class="cell center mt-30 mb-30">등록된 글이 없습니다.</div>
		</c:when>
		<c:otherwise>
			<div class="cell">
						        ...
						        <tr>
							        <td>
							        	...
							        	<div class="cell flex-box">
									        ...
									        <img src="${cp}/board/review/image?boardNo=${boardDetailVO.boardNo}" class="left thumb-60" >
								        	</a>
								        <div class="animal-container">
								        	<div class="top-container flex-box">
																								<c:if test="${not empty boardDetailVO.animalHeaderName and boardDetailVO.animalHeaderName ne '전체'}">
																										<div class="badge me-10">${boardDetailVO.animalHeaderName}</div>
																									</c:if>
																									<c:if test="${not empty boardDetailVO.typeHeaderName and boardDetailVO.typeHeaderName ne '전체'}">
																										<div class="badge me-10">${boardDetailVO.typeHeaderName}</div>
																									</c:if>
																									<div class="review-title"><a href="${detailUrl}"><c:out value="${boardDetailVO.boardTitle}"/></a></div>
									        		 <div class="review-reply red">[${boardDetailVO.boardReply}]</div>
									        	</div>
									        	<div class="bottom-container flex-box">
									        		<img class="avatar-24">
									        		<div class="ms-10 review-writer"><a class="profile-link" href="${writerUrl}">[<c:out value="${boardDetailVO.memberNickname}"/>]</a></div>
