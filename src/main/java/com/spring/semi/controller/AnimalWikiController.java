...
/**
 * AnimalWikiController - 웹 요청을 처리하는 MVC 컨트롤러.
 */
@Controller
...
public class AnimalWikiController {
            			...
            			@RequestParam(required = false) String noticePinEnd) throws IllegalStateException, IOException
    {
		...
		noticeService.afterWrite(boardNo, boardDto.getBoardTypeHeader(), noticePinOrder, noticePinStart, noticePinEnd, loginId, 7, null, boardDto.getBoardTitle());
			...
			@RequestParam(required = false) String noticePinEnd) throws IllegalStateException, IOException
	{
		...
		noticeService.afterEdit(boardDto.getBoardNo(), beforeDto.getBoardTypeHeader(), boardDto.getBoardTypeHeader(), noticePinOrder, noticePinStart, noticePinEnd, loginId, 7, null, boardDto.getBoardTitle());
