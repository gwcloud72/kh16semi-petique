...
/**
 * PetfluencerController - 웹 요청을 처리하는 MVC 컨트롤러.
 */
@Controller
...
public class PetfluencerController {
            			...
            			@RequestParam(required = false) String noticePinEnd) throws IllegalStateException, IOException
    {
		...
		noticeService.afterWrite(boardNo, boardDto.getBoardTypeHeader(), noticePinOrder, noticePinStart, noticePinEnd, loginId, 3, null, boardDto.getBoardTitle());
			...
			@RequestParam(required = false) String noticePinEnd) throws IllegalStateException, IOException
	{
		...
		noticeService.afterEdit(boardDto.getBoardNo(), beforeDto.getBoardTypeHeader(), boardDto.getBoardTypeHeader(), noticePinOrder, noticePinStart, noticePinEnd, loginId, 3, null, boardDto.getBoardTitle());
