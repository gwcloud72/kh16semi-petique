						        ...
						        <tr>
							        <td>
							        	...
							        	<div class="cell flex-box">
									        ...
									        <img src="${cp}/board/animal/image?boardNo=${boardDetailVO.boardNo}" class="left thumb-60" >
								        	</a>
								        <div class="animal-container">
								        	<div class="top-container flex-box">
								        		 <div class="animal-title"><a href="${detailUrl}"><c:out value="${boardDetailVO.boardTitle}"/></a></div>
								        		 <div class="animal-reply red">[${boardDetailVO.boardReply}]</div>
								        	</div>
								        	<div class="bottom-container flex-box">
								        		<img class="avatar-24">
								        		<div class="ms-10 animal-writer"><a class="profile-link" href="${writerUrl}">[<c:out value="${boardDetailVO.memberNickname}"/>]</a></div>
